...
public:
	...
	virtual bool GetGameEndCountDownStarted()
	{
		return m_GameEndCountDownStarted;
	}
	virtual uint32_t GetGameEndCountDownCounter()
	{
		return m_GameEndCountDownCounter;
	}
	...
	virtual void SetGameEndCountDownStarted (bool nGameEndCountDownStarted)
	{
		m_GameEndCountDownStarted = nGameEndCountDownStarted;
	}
	virtual void SetGameEndCountDownCounter (uint32_t nGameEndCountDownCounter)
	{
		m_GameEndCountDownCounter = nGameEndCountDownCounter;
	}
